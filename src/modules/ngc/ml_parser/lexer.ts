...
export function tokenize(
  ...
  return new MlTokenizer(new ParseSourceFile(source, url), getTagDefinition, options).tokenize();
}
...
class MlTokenizer {
  ...
  private _createError(msg: string, span: ParseSourceSpan): MlControlFlowError {
    if (this._isInExpansionForm()) {
    ...
    this._currentTokenStart = null;
    this._currentTokenType = null;
    return new MlControlFlowError(error);
  }
  ...
  private handleError(e: any) {
    ...
    if (e instanceof MlControlFlowError) {
